...
def parse_args():
    ...
    parser.add_argument('--plot-type', type=str, choices=['num_cluster', 'precisionSimga5', 'mov_stationary_cluster', 
...
def main():
    ...
    if args.plot_type == 'precisionSimga5':
        ...
        rcs_categories, cf_indices = plot_rcs_cluster(all_results, cf_indices)
        plot_percentage_rcs_status_cluster(rcs_categories, cf_indices)
